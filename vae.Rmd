...
loss_fun <- function(input) {
  ...
  cross_entropy <- nn_bce_loss(reduction = "sum")
...
On vérifie sur un exemple simple que la fonction de perte est bien définie:

```{r}

loss_fun(input[1, , drop = FALSE])
```
